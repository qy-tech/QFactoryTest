...
{
    QString time = QDateTime::currentDateTimeUtc().toString("yyyy-MM-dd HH:mm:ss");

    ui->label->setText(QString("将系统默认时间设置为：2021-12-31 23:59:59\n获取到系统当前时间为：%1")
                           .arg(time));
}
